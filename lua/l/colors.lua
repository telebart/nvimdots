vim.api.nvim_set_hl(0, "Keyword", { fg = "#3298b8", bold = true })
...
vim.api.nvim_set_hl(0, "LspCodeLens", { fg = "NvimLightYellow", italic = true })

vim.api.nvim_set_hl(0, "@markup.heading.delimiter.markdown", { fg = "#3298b8", bold = true })
vim.api.nvim_set_hl(0, "@markup.raw.markdown_inline", { fg = "#3298b8" })
...
vim.api.nvim_set_hl(0, "@markup.heading.1.markdown", { fg = "#3298b8", bold = true })
...
vim.api.nvim_set_hl(0, "@markup.rule.markdown", { fg = "#3298b8" })
vim.api.nvim_set_hl(0, "@markup.raw.delimiter.markdown_inline", { fg = "NvimLightYellow" })
vim.api.nvim_set_hl(0, "@markup.link.label.markdown_inline", { fg = "#3298b8", underline = true })
...
vim.api.nvim_set_hl(0, "@markup.link.reference.markdown", { fg = "#3298b8" })
...
vim.api.nvim_set_hl(0, "@escape.markdown", { fg = "#3298b8" })
