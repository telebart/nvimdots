...
return function(add)
  ...
  vim.keymap.set('n', '<leader>ds', function() widgets.centered_float(widgets.scopes, { border = "rounded" }) end)
  vim.keymap.set('n', '<leader>dw', function() widgets.centered_float(widgets.frames, { border = "rounded" }) end)
  vim.keymap.set('n', '<leader>da', function() widgets.hover(nil, {border="rounded"}) end)
  vim.keymap.set('n', '<leader>dq', function() vim.ui.input(nil, function (input)
    widgets.hover(input, {border="rounded"})
  end)end)
